...
Write a program that stores five grocery item names in one array and prints the last last item from grocery list, then stores their prices in a second array 
