...
metadata_title: Conditional Statements - C++ Programming | V.Vidhya
slug: conditional-statements
featured: false
# ogImage: https://user-images.githubusercontent.com/53733092/215771435-25408246-2309-4f8b-a781-1f3d93bdf0ec.png
description: Learn Conditional Statements in C++ Programming by practicing exercises based on real-world scenarios with V.Vidhya.
...
<Admonition variant="note" title="important note">
    In practice, it is a really bad coding style to nest _**if**_ statements this way. 
    This example exists solely to illustrate the unintended side effects of such nesting and to understand
