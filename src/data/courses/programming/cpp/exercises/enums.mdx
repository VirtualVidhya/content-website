...
title: Enums
metadata_title: Enums - C++ Programming | V.Vidhya
slug: enums
featured: false
# ogImage: https://user-images.githubusercontent.com/53733092/215771435-25408246-2309-4f8b-a781-1f3d93bdf0ec.png
description: Learn Enums in C++ Programming by practicing exercises based on real-world scenarios with V.Vidhya.
...
Then define a variable named `troll` of type `MonsterType` and initialize it with the appropriate enumerator.
...
Create an enum called Day that represents days of the week (Monday to Sunday). Then, write a program where the user enters a number (1 to 7), and the 
program prints the corresponding day using the enum.
...
Create a simple program for a restaurant that allows users to view items from a small menu based on the type of food they're interested in. 
Each item in the menu has a name, a price, and belongs to a specific category like Starter, Main Course, Dessert, or Beverage.
...
A car rental service offers four types of cars: Sedan, SUV, Hatchback, and Luxury. Each type has a fixed rental price per day. A customer wants to 
rent a car and needs to know the total cost based on the car type they choose and the number of days they want it for.
...
A small store wants a basic weekly reporting system to keep track of its sales performance. The system should ask the user to enter the sales amount 
for each day of the week, and then provide a summary report that shows which day had the highest and lowest sales, along with the average sales for 
the week.
