...
Write a program that asks for a person's birthdate and then tells them their exact age - years, months and days - as of today. 
The program should check if the date is valid and correctly handle leap years and months of different lengths.

<Admonition variant="hint" title="hint">
    **<LinkMd href="https://docs.python.org/3/library/datetime.html" title="datetime" />** module can be used for all the date and time related operations.
</Admonition>

<div class="w-full mt-6 mb-2"></div>
