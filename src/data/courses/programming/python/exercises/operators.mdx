...
(For e.g. if someone is 11th in line, they should get seat 1 again because the seats are arranged in a circle. If someone is 12th, they get seat 2
and so on.)
...
- Then calculate a 18% <LinkMd href="https://en.wikipedia.org/wiki/Goods_and_Services_Tax_(India)" title='GST' /> (tax) on the total cost of the items and print that **GST Amount**
...
{/* <Admonition variant="note" title="note">
    For simply calculating the value of a mathematical expression, feel free to use the calculator.
</Admonition> */}
