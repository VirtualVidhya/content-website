...
title: Hangman Game
metadata_title: Hangman Game - Python Programming | V.Vidhya
slug: hang-man-game
featured: false
# ogImage: https://user-images.githubusercontent.com/53733092/215771435-25408246-2309-4f8b-a781-1f3d93bdf0ec.png
description: Learn Python Programming by making a fun interactive text-based Hangman game.
...
Build a text-based <LinkMd href='https://en.wikipedia.org/wiki/Hangman_(game)' title='Hangman' /> game where the player first selects a word category (e.g., Animals, Countries, Fruits etc.). The program then picks 
