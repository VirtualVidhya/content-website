...
![Image 1](@/assets/courses/programming/webdev/js/exercises/dom-events-I/1.png)
...
![Image 2](@/assets/courses/programming/webdev/js/exercises/dom-events-I/2.png)

Once you click on it, it goes into `off` state.

![Image 3](@/assets/courses/programming/webdev/js/exercises/dom-events-I/3.png)
