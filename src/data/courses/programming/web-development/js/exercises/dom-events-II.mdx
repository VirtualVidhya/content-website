...
![Image 6](@/assets/images/courses/programming/webdev/js/exercises/dom-events-II/6.png)

Now on pressing the `Escape` key, a header menu bar should pop-up (toggle).

**Expected Output:**

![Image 7](@/assets/images/courses/programming/webdev/js/exercises/dom-events-II/7.png)
...
![Image 1](@/assets/images/courses/programming/webdev/js/exercises/dom-events-II/1.png)
...
![Image 2](@/assets/images/courses/programming/webdev/js/exercises/dom-events-II/2.png)
...
![Image 3](@/assets/images/courses/programming/webdev/js/exercises/dom-events-II/3.png)
...
- Ineligible
    ...
    ![Image 4](@/assets/images/courses/programming/webdev/js/exercises/dom-events-II/4.png)

- Eligible

    ![Image 5](@/assets/images/courses/programming/webdev/js/exercises/dom-events-II/5.png)
