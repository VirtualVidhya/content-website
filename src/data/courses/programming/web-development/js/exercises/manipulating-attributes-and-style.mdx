...
metadata_title: Manipulating Attributes & Style - JavaScript Programming | V.Vidhya
slug: manipulating-attributes-and-style
featured: false
# ogImage: https://user-images.githubusercontent.com/53733092/215771435-25408246-2309-4f8b-a781-1f3d93bdf0ec.png
description: Learn Manipulating Attributes & Style in JavaScript Programming by practicing exercises based on real-world scenarios with V.Vidhya.
...
![Image 5](@/assets/images/courses/programming/webdev/js/exercises/manipulating-attributes-and-style/5.png)
...
![Image 4](@/assets/images/courses/programming/webdev/js/exercises/manipulating-attributes-and-style/4.png)
![Image 1](@/assets/images/courses/programming/webdev/js/exercises/manipulating-attributes-and-style/1.png)
![Image 2](@/assets/images/courses/programming/webdev/js/exercises/manipulating-attributes-and-style/2.png)
![Image 3](@/assets/images/courses/programming/webdev/js/exercises/manipulating-attributes-and-style/3.png)

<Admonition variant="note" title="note">
    While naming your image files and choosing their directory location, please follow the above HTML code. If you
...
- The image icons for CSS & JS list items are the same as HTML currently. Set the image of CSS & JS items to their respective icons using `setAttribute()` but before setting the image first ensure that you are setting the correct icon for the matching image element. (for e.g. check if the `alt` of an image is `CSS-icon` then only set css icon image for it.)
    ...
    <Admonition variant="hint" title="hint">
        Use **_getAttribute()_** to first know what is the value of **_alt_** for the respective image element.
    </Admonition>
